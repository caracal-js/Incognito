    ...
    pages: {
        home: `<div class="prox-container" style="display:none">
            ...
            <div id="search-wrapper">
                <div id="form">
                    <a title="Proxy selection" class="form-control" id="search-option" data-open="true"><span></span></a>
                    <input placeholder="Type in a keyword or URL" id="search-box">
                    <a title="Initate Search" class="form-control" id="init"><span></span></a>
                </div>
        ...
        switch (page) {
            case 'home':
                __incog.home = {
                    ...
                    initateSearchButton: document.querySelector('#search-wrapper #form #init'),
                    gateway: {
                ...
                __incog.home.initateSearchButton.addEventListener('click', () => __incog.home.omniBox.value.trim() != '' ? (() => {
                    switch (localStorage.getItem('__incog_prox')) {
                        case 'alloy':
                            __incog.home.gateway.init(`//client.${__incog.domain}/portal?url=${encodeURIComponent(btoa(__incog.home.omniBox.value))}&type=ap`);
                        break;
